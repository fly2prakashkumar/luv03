      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex mb-8">
            <RadioGroup
              ...
              className="relative flex items-center bg-white shadow-[0_0_1px_0_rgba(24,94,224,0.15),0_6px_12px_0_rgba(24,94,224,0.15)] p-2 rounded-full w-full"
            >
                {TABS.map((tab, index) => (
                    <div key={tab} className="flex-1">
                        ...
                        <Label
                            htmlFor={tab}
                            className={cn(
                                "flex items-center justify-center h-8 text-sm font-medium rounded-full cursor-pointer transition-colors z-10",
